<div class="bg-white w-full border-b-[1px] border-solid border-[#dddddd]">
    <div class="max-w-container mx-auto">
        <div class="flex items-center py-5">
            <a href="/" class="block text-red-500">
            ...
            <div class="flex-1">
                <form action="" method="post"
                    class="flex w-1/3 mx-auto text-center shadow-searchForm p-2 border-solid border-[1px] border-[#DDDDDD] rounded-full overflow-hidden">
                    <input type="text" placeholder="Nhập địa điểm bất kì..." name="" id=""
